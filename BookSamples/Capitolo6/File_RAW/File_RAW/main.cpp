...
int main(void)
{
    ...
    fs.open("myFile.raw", fstream::out | fstream::binary);
    fs.write( (const char*)data.recordedSamples, totalFrames * NUM_CANALI * sizeof(float) );
    fs.close();
    cout << "Dati scritti nel file 'myFile.raw'" << endl;
